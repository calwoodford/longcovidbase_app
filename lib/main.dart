              ...
              child: Column(
                ...
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      const SizedBox(width: 200.0, height: 140.0),
                      Image.asset(
                      ...
                      const SizedBox(width: 200.0, height: 30.0),
                      Text(
                        'longcovidbase.com',
                        style: GoogleFonts.montserrat(
                      ...
                      const SizedBox(width: 200.0, height: 60.0),
                      Container(
                        width: 245,
                      ),
                    ],
...
class MyWidget extends StatefulWidget {
  ...
  const MyWidget({super.key, required this.labelText, this.suffixIcon});
